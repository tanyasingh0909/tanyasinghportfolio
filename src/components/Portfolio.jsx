   ...
   <div class="timeline">
        <div class="timeline-event">
            ...
            <div class="timeline-content">
                <h3>Graduation</h3>
                <p class='para-p'>I completed my B.tech degree in Chemical Engineering from Indian Institute of Technology,Kanpur.</p>
            </div>
        </div>
        <div class="timeline-event">
            ...
            <div class="timeline-content">
                <h3>Schooling</h3>
                <p class='para-p'>I completed my schooling from Shivaji Group Of Institutions,Kanpur with PCM stream.</p>
            </div>
        </div>
    </div>
